...
public class NeuronLayer implements Iterable<Neuron>{
	...
	public NeuronLayer(int nrOfNeurons, String name, NeuralNet net) {
		this(1, nrOfNeurons, name, net);	
	}
	
	public NeuronLayer(int nrOfGroups, int nrOfNeurons, String name, NeuralNet net) {
	...
	public void connectTo(NeuronLayer next) {	
